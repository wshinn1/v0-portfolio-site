...
export function AboutSection({ content }: AboutSectionProps) {
  return (
    <section id="about" className="min-h-screen bg-[#f0f0f0] py-24">
      <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 px-8 lg:px-16 max-w-7xl mx-auto">
        {/* Left Column - Label and Heading */}
        <div className="lg:w-1/3 lg:sticky lg:top-24 lg:self-start">
          {/* Section Label */}
          <span className="inline-block px-3 py-1 text-xs font-semibold tracking-wider uppercase bg-[#1a1a1a] text-white rounded-full mb-6">
            {content.label}
          </span>
        ...
        <div className="lg:w-2/3">
          {/* Job Title */}
          <h3 className="text-2xl lg:text-3xl font-bold text-[#1a1a1a] mb-6">
            {content.jobTitle}
          </h3>
